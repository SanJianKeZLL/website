...
async function init() {
  ...
  shaders[1].uniform.u_tex0.value = await new THREE.TextureLoader().loadAsync("media/snow_tree.JPG");
    ...
    case "snow":
      {
        ...
        material.uniforms.u_tex0_resolution.value = new THREE.Vector2(1920, 1080);
        material.uniforms.u_tex0.value = await new THREE.TextureLoader().loadAsync("media/snow_tree.JPG");
      }
      break;
    case "clouds":
      {
